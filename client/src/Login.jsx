...
import { authFetch } from './api'  // use shared helper
...
function Login({ onToggle, onLoginSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Extract token either from header or response body (CORS can hide headers)
      let token = null;
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          <div className="form-group">
            ...
            <input
              ...
              autoComplete="email"
            />
            <small className="input-hint">Use your NITJ student email</small>
          </div>
